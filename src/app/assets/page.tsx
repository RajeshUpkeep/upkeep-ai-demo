...
export default function AssetsPage() {
  ...
  const applyFilters = () => {
    ...
    if (locationFilter) {
      filtered = filtered.filter(asset => 
        asset.location.toLowerCase() === locationFilter.toLowerCase()
      );
    }
    ...
    setIsFiltered(nameFilter !== '' || typeFilter !== '' || locationFilter !== '' || statusFilter !== '');
  };
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">Manage and track equipment and assets</p>
          </div>
          
          {/* Assets Section */}
          <div>
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">All Assets</h2>
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <div className="flex-1 min-w-[200px]">
                    ...
                    >
                      ...
                      <option value="manufacturing equipment" className="text-gray-800">Manufacturing Equipment</option>
                      <option value="material handling" className="text-gray-800">Material Handling</option>
                      <option value="utility" className="text-gray-800">Utility</option>
                    </select>
                  </div>
                  ...
                  <div className="flex-1 min-w-[200px]">
                    ...
                    >
                      ...
                      <option value="operational" className="text-gray-800">Operational</option>
                      <option value="needs attention" className="text-gray-800">Needs Attention</option>
                      <option value="down for maintenance" className="text-gray-800">Down for Maintenance</option>
                      <option value="out of service" className="text-gray-800">Out of Service</option>
                    </select>
                  </div>
                ...
                <table className="min-w-full bg-white rounded-lg overflow-hidden shadow-md">
                  <thead className="bg-gray-100 text-gray-700">
                    <tr>
                      ...
                      <th className="py-3 px-4 text-left font-medium">Next Maintenance</th>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {filteredAssets.map((asset) => (
                      ...
                      >
                        <td className="py-3 px-4 text-sm text-gray-800">{asset.id}</td>
                        ...
                        <td className="py-3 px-4 text-sm text-gray-800">{asset.type}</td>
                        <td className="py-3 px-4 text-sm text-gray-800">{asset.location}</td>
                        <td className="py-3 px-4">
                          <div className="flex items-center">
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${getHealthScoreColor(asset.healthScore)}`}>
                              {asset.healthScore}%
                            </span>
                          </div>
                        </td>
                        <td className="py-3 px-4 text-sm text-gray-800">{formatDate(asset.nextMaintenanceDate)}</td>
                        <td className="py-3 px-4">
