...
const Sidebar: React.FC<SidebarProps> = ({ activeTab }) => {
  const navItems = [
    ...
    { name: 'Preventive Maintenance', href: '/preventive', icon: 'clock' },
  ...
  return (
    <aside className="bg-gray-800 text-white w-64 min-h-screen p-4">
      <div className="mb-8">
        <h2 className="text-xl font-bold">UpKeep</h2>
        <p className="text-gray-400 text-sm">Maintenance Management</p>
      </div>
      <nav>
      ...
      <div className="mt-auto pt-8">
        <div className="bg-gray-700 p-4 rounded-lg">
          ...
          <p className="text-sm text-gray-300">
            Your AI assistant is analyzing your work orders and maintenance data.
          </p>
        </div>
      </div>
    </aside>
